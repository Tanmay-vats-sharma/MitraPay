...
import profile_pic from "../assets/mohitgoel.jpeg"
          ...
          <div className="h-[calc(100%-4rem)] flex flex-col justify-evenly">
            ...
            <div className="h-5/6 flex ">
              <div className="h-full w-1/2 flex justify-center items-center  ">
                <div className="h-[95%] bg-white w-[60%] flex flex-col justify-evenly items-center">
                  <div className="h-[24%] w-full flex flex-col items-center justify-center space-y-2  ">
                    <div className="h-[100%] w-[21%] overflow-hidden rounded-full  ">
                  ...
                  <div className="h-[25%] w-full flex justify-evenly items-center ">
                    <div className="h-[100%] w-[40%] flex flex-col items-left justify-evenly pl-3 border-2">
                    ...
                    <div className="h-[100%] w-[40%] flex items-left justify-evenly flex-col pl-3 border-2">
                  ...
                  <div className="h-[8.5%] w-full flex items-center justify-center  ">
                    <button className="h-[100%] w-[85%] rounded-md  bg-blue-600 text-white">
                      Continue →
                    </button>
                  </div>
                </div>
              </div>
              <div className="h-full w-1/2 border-blue-600 border-4"></div>
            </div>
