  ...
  return (
      <>
        <div className="grid grid-cols-10 grid-rows-8 gap-3   p-5 min-h-screen \">
          ...
          <div className="bg-blue-50 rounded-lg col-span-2 row-span-8 p-1">
            <Balance></Balance>
          </div>
          <div className=" col-span-2  row-span-7  p-1 ">
            <Navbar></Navbar>
          </div>
          <div className="bg-blue-50 rounded-md col-span-6 row-span-3 "></div>
          <div className="bg-blue-50 rounded-md  col-span-6 row-span-4">4</div>
        </div>
      </>
    );
}
