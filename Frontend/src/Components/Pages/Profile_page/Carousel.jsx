    ...
    <div className="flex flex-col items-center space-y-4">
      <div className="relative flex items-center space-x-8">
        ...
        <div className="relative w-40 h-40  overflow-hidden transform transition-all duration-1000 ease-in-out scale-110 brightness-100">
          ...
          {/* Edit Button */}
          <button
            className="absolute top-1.5 right-1.5 w-10 h-10 bg-blue-200 text-white rounded-full flex items-center justify-center text-lg shadow-md hover:bg-blue-600 z-[0]"
            aria-label="Edit"
