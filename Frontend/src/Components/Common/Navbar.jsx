...
function Navbar1() {
    return (
        <aside className="hidden sm:flex sm:flex-col h-screen fixed left-0 overflow-y-auto">
...
function Navbar2() {
    return (
        <div class="flex flex-col h-screen top-0 left-0 w-64 bg-white border-r">
            {/* <!-- Sidebar Header with Logo --> */}
            <div class="flex items-center  h-16">
                <img src={Logo} alt="Logo" class="h-10 w-auto" />
                <h1 class="text-2xl font-bold tracking-wide text-[#FDF209]">MitraPay</h1>
            </div>
            <div class="overflow-y-auto overflow-x-hidden flex-grow border-t-2">
                <ul class="flex flex-col py-2 space-y-2">
                    <li class="px-5 pt-4">
                        <div class="flex flex-row items-center h-8">
                            <div class="text-2xl text-center font-semibold tracking-wide text-gray-500 ">Menu</div>
                        </div>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="#" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
                            ...
                            <span class="ml-2 text-sm tracking-wide truncate">Contacts</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
                            ...
                            <span class="ml-2 text-sm tracking-wide truncate">Transfers</span>
                        </a>
                    ...
                    <li class="px-5 border-t-2 mt-12 pt-4 ">
                        <div class="flex flex-row items-center h-8">
                            <div class="text-2xl font-semibold tracking-wide text-gray-500">Settings</div>
                        </div>
                    </li>
                    <li>
                        <a href="#" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
...
function Navbar3() {
    return (
        <div class="fixed min-h-screen flex flex-col top-0 left-0 w-64 bg-yellow-100 h-full border-r space-x-10">
            <div>
                Naman
            </div>
            <div>
