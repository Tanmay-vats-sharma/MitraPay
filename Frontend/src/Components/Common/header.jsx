...
export function Header() {
  return (
    <>
      <div className="flex items-center justify-center  h-[100%] w-[24%] shadow-md  rounded-lg bg-white">
      ...
      <div className="h-[100%] w-[75%] flex justify-evenly items-center shadow-md  rounded-lg bg-white px-2">
