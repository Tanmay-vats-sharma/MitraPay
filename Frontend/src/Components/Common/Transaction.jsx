...
export function Transaction({ name, date, time, amount, image }) {
  ...
  return (
    <>
      <a href="" className="flex justify-evenly items-center w-[730px] h-[40px] border-b-2 bg-gray-50 px-2 pl-5 border-blue-200 hover:bg-blue-100 rounded-md hover:border-b-blue-400 mb-[6px] ">
